...
public class OfficerMenu {
    ...
    public int showOfficerOptions() {
        ...
        System.out.println("2. View Available Projects with filter");
        System.out.println("3. Apply for BTO Project");
        System.out.println("4. View Application status");
        System.out.println("5. Submit/View/Edit/Delete Enquiries");
        ...
        System.out.println("9. View Assigned Projects");
        System.out.println("10. View Project Details");
        System.out.println("11. Book Flat for Applicant, then generate receipt");
